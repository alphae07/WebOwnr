...
export default function EditorClient({ siteSlug }: { siteSlug: string }) {
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="space-x-2">
          <a
            ...
            href={`https://${siteSlug}.webownr.com`}
            target="_blank"
            rel="noreferrer"
          >
            View Live
          </a>
          <Link className="px-3 py-2 rounded bg-gray-100" href="/dashboard">
            Back to Dashboard
          </Link>
        </div>
      </div>
