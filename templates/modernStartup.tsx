...
export default function SimpleBusiness({ site }: { site: any }) {
  return (
    <div className="font-sans">
      ...
      <section className="bg-[#e0f2fe] py-20 text-center">
        <h2 className="text-4xl font-bold mb-4">{site.tagline}</h2>
        <p className="max-w-2xl mx-auto text-gray-700">{site.about}</p>
      </section>
      ...
      <section id="services" className="py-16 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            {(site.services || ["Custom Development", "E-commerce Setup", "Brand Consulting"]).map((service: string, i: number) => (
      ...
      <section id="about" className="bg-[#f1f5f9] py-16 text-center">
        ...
        <p className="max-w-3xl mx-auto text-gray-700">{site.about}</p>
      </section>

      <section id="contact" className="py-16 bg-white">
        <div className="max-w-md mx-auto text-center">
          <h3 className="text-2xl font-bold mb-4">Contact Us</h3>
          <p>Email: {site.email || "support@webownr.com"}</p>
